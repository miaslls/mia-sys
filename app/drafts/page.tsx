...
const draftRoutes = [
  {
    ...
    description:
      'A botanical interface sample covering theme, hero, cards, and brand expression.',
  },
  {
  ...
  },
  {
    ...
    eyebrow: 'Structure',
    description:
      'Spacing, card anatomy, lists, navigation, and responsive layout examples.',
  },
  {
    href: '/drafts/article',
    title: 'Article',
    ...
    description:
      'Editorial page draft for long-form design-system content and related resources.',
  },
];
        ...
        <header className='flex flex-col gap-5 border-b border-white/10 pb-8 md:flex-row md:items-end md:justify-between'>
          <div className='max-w-3xl'>
            ...
            <p className='mt-4 max-w-2xl text-sm leading-6 text-zinc-400 sm:text-base'>
              Active child routes for reviewing interface explorations, design
              system sections, and content drafts.
            </p>
          </div>
