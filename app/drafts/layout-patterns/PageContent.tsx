...
export default function LayoutPatternsPageContent() {
  ...
  const insetClass = isDark ? 'border-white/10 bg-white/[0.03]' : 'border-black/10 bg-[#F7F6F2]';
      ...
      <div className="relative mx-auto max-w-6xl space-y-8 md:space-y-12">
        ...
        <header className="flex flex-col items-start justify-between gap-5 md:flex-row md:items-center md:gap-8">
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <div>
              ...
              >
                Layout & Patterns <span className="ml-1 text-lime-500 sm:ml-2">v 0.1.0</span>
              </p>
            </div>
          </div>
        ...
        >
          <div className="mb-7 flex items-center gap-5">
            ...
            <h2 className="text-xl font-light uppercase tracking-wide">Spacing & Layout</h2>
          </div>
          ...
          >
            ...
            <div className="space-y-5 md:px-6">
              ...
              >
                ...
                <span className="rounded-md bg-black/20 px-3 py-2 text-white">Max 1280px</span>
                <span className="text-lime-300">64px</span>
              </div>
            ...
            <div className="space-y-5 lg:pr-6">
              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-[minmax(0,1fr)_220px] md:items-start">
                ...
                <div className="space-y-3 md:justify-self-end">
                  <p className="text-xs uppercase tracking-wide">Mobile - 4 Column Grid (360px)</p>
                  <div
        ...
        >
          <div className="mb-7 flex items-center gap-5">
            ...
            <h2 className="text-xl font-light uppercase tracking-wide">Cards & Lists</h2>
          </div>
          ...
          >
            <div className="space-y-5 xl:pr-6">
              ...
              <div className="flex flex-col gap-5 md:flex-row md:items-center">
                <div className={`w-full max-w-xs rounded-2xl border p-5 ${insetClass}`}>
                  ...
                  <div
                    className={`flex items-center justify-between border-t pt-4 ${dividerClass}`}
                  >
            ...
            <div className="space-y-5 xl:pl-6">
              ...
              <div className="relative h-40">
                ...
                <div
                  className={`absolute left-0 top-8 w-[84%] rounded-2xl border p-5 ${stackedCardClass}`}
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p
                        className={`mt-1 max-w-[190px] text-[10px] leading-relaxed ${mutedTextClass}`}
                      >
          ...
          <div className={`border-b py-7 ${dividerClass}`}>
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div
                  className={`relative min-h-40 overflow-hidden rounded-2xl border p-5 ${insetClass}`}
                >
        ...
        >
          <div className="mb-7 flex items-center gap-5">
            ...
            <h2 className="text-xl font-light uppercase tracking-wide">Navigation / Tabs</h2>
          </div>
          ...
          >
            <div className="space-y-5 xl:pr-6">
              ...
              <nav
                className={`flex h-14 items-center justify-between rounded-2xl border px-4 ${insetClass}`}
              >
            ...
            <div className="space-y-5 xl:px-6">
              ...
              <div className="flex gap-5">
                <aside
                  className={`flex w-14 flex-col items-center gap-5 rounded-2xl border py-4 ${insetClass}`}
                >
            ...
            <div className="space-y-5 xl:pl-6">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div
                    className={`flex h-12 items-center justify-between rounded-2xl border px-4 ${insetClass}`}
                  >
